...
var SearchService = /** @class */ (function () {
    ...
    SearchService.prototype.getRecords = function (query) {
...
var SearchComponent = /** @class */ (function () {
    ...
    SearchComponent.prototype.onSearch = function () {
        var me = this;
        var finalQuery = { "query": me.query.trim() };
        console.log(finalQuery);
        me.result = [];
        me.showTable = false;
        me.searchService.getRecords(finalQuery).subscribe(function (results) {
            me.result = results;
            me.showTable = true;
        });
    };
...
module.exports = __webpack_require__(/*! C:\project\jsonParsing\ui\JSONParser\src\main.ts */"./src/main.ts");
